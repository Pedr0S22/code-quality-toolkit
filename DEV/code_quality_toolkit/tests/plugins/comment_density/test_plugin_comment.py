...
def test_plugin_configuration():
    ...
    custom_rules = RulesConfig(
        min_comment_density=0.25, 
        max_comment_density=0.75
    )
...
@pytest.mark.parametrize("code_sample, expected_code_lines, expected_comment_lines", [
