...
# Como usar e configurar o plugin de Métricas Básicas (`BasicMetrics`)

O plugin **BasicMetrics** calcula métricas simples sobre cada ficheiro de código analisado, como número de linhas, comentários e algumas métricas de Halstead.  
Este documento explica **como o utilizador corre o plugin**, **como configurar** e **como interpretar o resultado**.
