    ...
    def analyze(self, source: str, filename: str) -> dict[str, Any]:
        ...
        try:
                ...
                issues.append(
                    {
                        ...
                        "severity": "high",
                        "hint": "Consider adding more comments to improve "
                        + "documentation",
                    }
                )
                ...
                issues.append(
                    {
                        ...
                        "severity": "high",
                        "hint": "Consider if some comments could be removed or "
                        + "simplified",
                    }
                )
            ...
            return {
                ...
                "summary": {"issues_found": 1, "status": "partial", "error": str(exc)},
            }
            ...
            return {
                ...
                "summary": {"issues_found": 1, "status": "error", "error": str(exc)},
            }
